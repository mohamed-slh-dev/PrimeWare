                    ...
                    <div class="card mb-0">
                        <div class="card-body pb-0">
                            ...
                            <div class="text-center">
                                <div class="">
                                    <a href="javascript:void(0);"><img class="login-logo" src="{{ asset('assets/partners/assets/images/Prime-logo1.png') }}"
                                            height="90" width="150" alt="logo"></a>
                                </div>
                            </div>
                            ...
                            {{-- headings --}}
                            <div class="p-3">
                                <h4 class="font-size-18 text-muted mt-2 text-center">Welcome To Partners Portal !</h4>
                                <p class="text-muted text-center mb-4">Sign in to continue to PARTNERS dashboard.</p>


                                {{-- login form --}}
                                <form action="{{ route('otherpartner.checkuser') }}" method="post">
                                    ...
                                    <div class="form-group mb-0 row align-items-center">
                                        ...
                                        {{-- <div class="col-sm-6 text-right mt-2">
                                            <a href="{{ route('admin.login') }}" class="btn login-switch-button w-md
                                        waves-effect waves-light">Switch To User</a>
                                    </div> --}}
                            ...
                            <div class="form-group row mt-4">
                                ...
                                <a href="{{route('admin.login')}}">
                                    <button class="btn btn-outline-success w-md waves-effect waves-light font-size-12" type="submit">Admin Portal</button>
                                </a>
                            </div>
                            <div class="col-sm-4 text-center my-2">
                                <a href="{{route('partner.login')}}">
                                    <button class="btn btn-outline-success w-md waves-effect waves-light font-size-12" type="submit">Rest. Portal</button>
                                </a>
                            </div>
                            <div class="col-sm-4 text-center my-2">
                                <a href="javascript:void(0);">
                                    <button class="active btn btn-outline-success w-md waves-effect waves-light font-size-12" type="submit">Partners Portal</button>
                                </a>
                            </div>

                            {{-- <div class="col-sm-6 text-center my-2">
                                <a href="{{route('supplier.login')}}">
                                    <button class=" btn btn-outline-success w-md waves-effect waves-light font-size-12" type="submit">Supplier Portal</button>
                                </a>
                            </div> --}}
