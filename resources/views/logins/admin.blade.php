                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card mb-0">
                        <div class="card-body pb-0">
                            ...
                            {{-- headings --}}
                            <div class="p-3">
                                <h4 class="font-size-18 text-muted mt-2 text-center">Welcome To Admins Portal !</h4>
                                <p class="text-muted text-center mb-4">Sign in to continue to ADMINS dashboard.</p>


                                {{-- login form --}}
                                <form action="{{ route('admin.checkuser') }}" method="post">
                                    ...
                                    <div class="form-group mb-0 row">
                                        ...
                                        {{-- <div class="col-sm-6 text-right mt-2">
                                            <a href="{{ route('partner.login') }}" class="btn login-switch-button w-md waves-effect waves-light">Switch To Partner</a>
                                        </div> --}}
                                ...
                                <div class="form-group row mt-4">
                                    ...
                                    <a href="javascript:void(0);">
                                        <button class=" active btn btn-outline-success w-md waves-effect waves-light font-size-12" type="submit">Admin Portal</button>
                                    </a>
                                </div>
                                <div class="col-sm-4 text-center my-2">
                                ...
                                <div class="col-sm-4 text-center my-2">
                                    <a href="{{route('otherpartner.login')}}">
                                        <button class="btn btn-outline-success font-size-12" type="submit">Partners Portal</button>
                                    </a>
                                </div>
