                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card mb-0">
                        <div class="card-body pb-0">
                            ...
                            {{-- headings --}}
                            <div class="p-3">
                                <h4 class="font-size-18 text-muted mt-2 text-center">Welcome To Suppliers Portal !</h4>
                                <p class="text-muted text-center mb-4">Sign in to continue to SUPPLIERS dashboard.</p>


                                {{-- login form --}}
                                <form action="{{ route('supplier.check.login') }}" method="post">
