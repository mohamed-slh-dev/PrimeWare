        ...
        <header id="page-topbar">
            <div class="navbar-header">
                ...
                <div class="d-flex">
                    ...
                    <?php $notifications = \App\Models\OtherpartnerNotification::where('otherpartner_id', session('otherpartner_id'))->orderBy('created_at', 'DESC')->get(); ?>
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="{{ asset('assets/img/partners/logos/'.session()->get('otherpartner_logo')) }}"
                                alt="Avatar">
                        </button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- item-->
                            <a class="dropdown-item" href="{{ route('otherpartner.general') }}"><i
                            ...
                            {{-- logout --}}
                            <a class="dropdown-item" href="{{ route('otherpartner.logout') }}"><i
                ...
                <div class="container-fluid">
                    <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                        ...
                        <div class="collapse navbar-collapse" id="topnav-menu-content">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('otherpartner.dashboard') }}">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('otherpartner.deliveries') }}">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-advanced-ui">
                                        ...
                                        <a href="{{ route('otherpartner.collectedcash') }}" class="dropdown-item">Charge Fees</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-advanced-ui">
                                        ...
                                        <a href="{{ route('otherpartner.alldeliveryreports') }}" class="dropdown-item">Deliveries Reports</a>
                                ...
                                {{-- <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <i class="dripicons-device-desktop mr-2"></i>PrimeWare Delivery
                                    </a>
                                </li> --}}
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-advanced-ui">
                                        ...
                                        {{-- general settings --}}
                                        <a href="{{ route('otherpartner.general') }}" class="dropdown-item">General Settings</a>
            ...
            {{-- check if not authenticated to this otherpartner layout --}}
            @if (empty(session('otherpartner_id')))
                ...
                {{-- redirect to other partners login --}}
                @else
                
                <script>
                    window.location.href = '/login/partners';              
                </script>
            ...
            @endif
            {{-- end of check if not authenticated to otherpartner layout --}}
