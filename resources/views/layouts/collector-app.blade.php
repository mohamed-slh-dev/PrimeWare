            ...
            <div class="main-content">
                ...
                <footer class="footer" style="background:rgb(51,51,51); position:fixed; z-index:100;">
                    ...
                    <div class="row align-items-center home-footer">
                        <div class="col-3">
                        <a href="{{route('collector.home')}}">
                                <i class="fas fa-home" style="color : #fbbe00"></i>
                            </a>
                        </div>

                        <div class="col-3">
                        <a href="{{route('collector.return.cash.page')}}" style="color : #fbbe00">
                                <i class="fas fa-dollar-sign " ></i>
                            </a>
                        </div>

                        <div class="col-3">
                            <a href="{{route('collector.search.restaurant')}}">
                                <i style="color : #fbbe00" class="fas fa-search"></i>
                            </a>
                        </div>

                        <div class="col-3">
                            <a href="{{route('collector.profile')}}" style="color : #fbbe00">
