...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="{{ asset('assets/partners/assets/css/bootstrap.min.css') }}" id="bootstrap-style" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="{{ asset('assets/partners/assets/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="{{ asset('assets/partners/assets/css/app.min.css') }}" id="app-style" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('assets/general.css') }}" rel="stylesheet" type="text/css" />
     ...
     <link href="{{ asset('assets/chat/assets/css/icons.css') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{ asset('assets/partners/assets/images/Prime-logo1.png') }}" alt="" width="150" height="100">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('assets/partners/assets/images/Prime-logo1.png') }}" alt="" width="130" height="70"> </span>
                        </a>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-none d-md-block ml-2">
                        <button type="button" class="btn header-item waves-effect" data-toggle="dropdow"
                            ...
                            <img class="mr-2" src="{{ asset('assets/partners/assets/images/flags/us_flag.jpg') }}" alt="Header Language" height="16">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            {{-- <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('assets/partners/assets/images/flags/germany_flag.jpg') }}" alt="user-image" class="mr-1"
                                    height="12"> <span class="align-middle"> German </span>
                            </a> --}}

                            <!-- item-->
                            {{-- <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('assets/partners/assets/images/flags/italy_flag.jpg') }}" alt="user-image" class="mr-1" height="12">
                                <span class="align-middle"> Italian </span>
                            </a> --}}

                            <!-- item-->
                            {{-- <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('assets/partners/assets/images/flags/french_flag.jpg') }}" alt="user-image" class="mr-1"
                                    height="12"> <span class="align-middle"> French </span>
                            </a> --}}

                            <!-- item-->
                            {{-- <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('assets/partners/assets/images/flags/spain_flag.jpg') }}" alt="user-image" class="mr-1" height="12">
                                <span class="align-middle"> Spanish </span>
                            </a> --}}

                            <!-- item-->
                            {{-- <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('assets/partners/assets/images/flags/russia_flag.jpg') }}" alt="user-image" class="mr-1"
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        ...
                        <button class="btn header-item noti-icon waves-effect">
                            <a href="{{ route('partner.driverschat') }}">
                                ...
                                <span class="badge badge-success badge-pill" style="position: initial;">{{ $notif }}</span>
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user" src="{{ asset('assets/img/partners/logos/'.session()->get('partner_logo')) }}"
                                alt="Avatar">
                        </button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- item-->
                            ...
                            {{-- logout --}}
                            <a class="dropdown-item" href="{{ route('partner.logout') }}"><i class="dripicons-exit font-size-16 align-middle mr-2"></i> Logout</a>
                        </div>
                    </div>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-advanced-ui">
                                        ...
                                        <a href="{{ route('partner.managecustomers') }}" class="dropdown-item">Manage Customers</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-advanced-ui">
                                        ...
                                        <a href="{{ route('partner.collectedcash') }}" class="dropdown-item">Collected Cash</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-advanced-ui">
                                        ...
                                        {{-- reports --}}
                                        <a href="{{ route('partner.alldeliveryreports') }}" class="dropdown-item">Deliveries Reports</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-advanced-ui">
                                        ...
                                        <a href="{{ route('partner.general') }}" class="dropdown-item">General Settings</a>
