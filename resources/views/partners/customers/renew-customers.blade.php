        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-title-desc">View all renew requests</p>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ number_format($request->deliveriescount) }}</td>


                                            {{-- edit --}}
                                            <td>
                                                <button data-toggle="modal" data-target=".edit-customer" class="far fa-edit text-primary custom-edit-button customer-assign-id-2" value="{{ $request->customer->id }}"></button>

                                                <input type="hidden" id="customer-assign-request" value="{{ $request->id }}">
                                            </td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{-- form (search partner) --}}
                <form action="{{ route('partner.renewcustomer') }}" method="post">
