            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <div class="float-right d-none d-md-block">
                        ...
                        {{-- form (search partner) --}}
                        <form class="app-search" action="{{ route('admin.searchotherpartner') }}" method="post">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Other Partners Info.</h4>
                            <p class="card-title-desc">Manage all partners Info.</p>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.editotherpartner') }}" method="post" enctype="multipart/form-data">
