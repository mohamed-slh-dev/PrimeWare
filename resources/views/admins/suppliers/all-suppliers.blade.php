                ...
                <div class="col-sm-4">
                    <div class="float-right">
                        <button type="button" class="btn btn-outline-success waves-effect waves-light"
                            data-toggle="modal" data-target=".bs-example-modal-lg">Add Supplier</button>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="media">
                                <div class="col-12 text-center">
                                    <img class="mb-3 card-image-fit" src="{{ asset('assets/img/suppliers/logos/'.$supplier->logo) }}" width="170" height="75"
                                        alt="Generic placeholder image" style="object-fit:contain !important; width:200px !important; height:200px !important;">
                                    <div class="media-body">
                                        <h5 class="font-size-16 mb-1">{{ $supplier->name }}</h5>
                                        <p class="text-muted mb-0">{{ $supplier->portalemail }}</p>
                                        
                                        {{-- <p class="text-muted font-size-14 font-weight-medium font-secondary mb-0">{{ $supplier->type->name }}</p> --}}

                                        <p class=" font-size-16 font-weight-bold text-success">{{ $supplier->city->name }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- <div class="row text-center">
                                ...
                                <div class="col-6">
                                    <h5 class="mb-0">{{ $supplier->orders->count() }}</h5>
                                    <p class="text-muted font-size-14">Deliveries</p>
                                </div>

                                <div class="col-6">
                                    <h5 class="mb-0">{{ $supplier->deliveredorders->count() }}</h5>
                            ...
                            <ul class="social-links text-center list-inline mb-0 mt-3">
                                ...
                                <li class="list-inline-item">
                                    <button style="box-shadow:none !important; font-size:13px; padding:0px 8px; padding-bottom:2px;" title="" id="customer-assign-id" type="button" data-placement="top" class="tooltips btn btn-none customer-assign-id" data-target=".delete-supplier" data-toggle="modal" value="{{ $supplier->id }}"
                                ...
                                <li class="list-inline-item">
                                    <a title="" target="_blank" data-placement="top" data-toggle="tooltip"
                                        class="tooltips" href="https://www.google.com/maps/search/?api=1&query={{ ltrim($supplier->locationlink, '@') }}"
                                ...
                                <li class="list-inline-item">
                                    <a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href=""
                                        data-original-title="{{ $supplier->phone }}"><i class="fas fa-phone"></i></a>
                                </li>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="myLargeModalLabel">New Supplier</h5>
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input required="" name="contract" class="form-control" type="file"
                                        id="contract-input">
                                </div>
                                <div class="col-sm-4">
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input required="" placeholder="e.g: 12.2773737373, 257773737734"
...
{{-- delete supplier modal --}}
<div class="modal fade delete-supplier" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title mt-0 font-weight-bold" id="myLargeModalLabel">Delete Supplier ? </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
