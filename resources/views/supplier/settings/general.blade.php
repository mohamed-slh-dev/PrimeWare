...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('supplier.updatesettings') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="form-group row">
                            ...
                            {{-- restaurant name --}}
                            <div class="col-4">
                                <label for="example-text-input" class="col-sm-6 col-form-label">Supplier Name</label>
                                <div class="col-sm-10">
                            ...
                            <div class="col-4 mt-3">
                                ...
                                <div class="col-sm-10">
                                    <input required="" name="locationlink" class="form-control" type="text"
                                        id="example-text-input" value="{{ $supplier->locationlink }}">
                                </div>
                            </div>
                            ...
                            <div class="col-4 mt-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select id="districtselect" required="" name="district" class="custom-select">
                                        ...
                                        @elseif ($supplier->city_id == $district->samedistrict->city_id)
