    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            <div class="page-content" style="margin-top: 0px; padding:0px">
                <form action="{{ route('driver.check.login') }}" method="post">
                     {{-- method fields --}}
                     @method('POST')
                     @csrf
                 <div class="container-fluid">
                    ...
                    <div class="row align-items-center" style="background: rgb(42, 42, 42)">
                        ...
                        <div class="col-12 profile-cols">
                            ...
                            <p>
                                <input class="custom-control profile-custom-inputs" type="text" name="email" id="name" required="" placeholder="E-mail (Driver)">
                            </p>
                        </div>
                        ...
                        <div class="col-12 profile-cols">
                         ...
                         <!-- forget link -->
                         <div class="col-6 profile-cols">
                            <a href="#" class="text-white mt-3">
                                Forgot Password?
                            </a>
                        </div>

                        <div class="col-6  profile-cols text-right">
                            <input type="checkbox"  name="logged"  id="logged">
                            <label for="logged" class="text-white">Keep me logged in</label><br>
                        </div>
              ...
              <div class="row mb-4">
                ...
                <div class="col-6 profile-cols text-center">
                    <a href="#">
                    <button type="submit" disabled style="width:100%; background-color: white; color:black" class="btn btn-warning mt-5">
                        Login AS Driver
                    </button>
                    </a>
                </div>
                    ...
                    <a href="{{route('collector.login')}}">
                        <button type="submit" style="width:100%; background-color: white; color:black" class="btn btn-warning mt-5">
                            Login AS Collector
                        </button>
                    </a>
                    </div>
