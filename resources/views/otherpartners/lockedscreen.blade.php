                    ...
                    <div class="card mb-0">
                        <div class="card-body pb-0">
                            ...
                            <div class="p-3">
                                ...
                                <p class="text-muted text-center mb-4">Hello {{ session()->get('otherpartner_name') }}, enter your password to unlock the screen</p>


                                {{-- login form --}}
                                <form action="{{ route('otherpartner.otherpartnerunlock') }}" method="post">
