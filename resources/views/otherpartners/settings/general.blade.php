...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('otherpartner.updategeneral') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="form-group row">
                            ...
                            {{-- restaurant name --}}
                            <div class="col-4">
                                <label for="example-text-input" class="col-sm-6 col-form-label">Partner Name</label>
                                <div class="col-sm-10">
                                    <input name="name" required="" class="form-control" type="text"
                                        id="example-text-input" value="{{ $partner->name }}">
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="col-sm-10">
                                    <input name="email" required="" class="form-control" type="email"
                                        id="example-text-input" value="{{ $partner->email }}">
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="col-sm-10">
                                    <input name="phone" required="" class="form-control" type="text"
                                        id="example-text-input" value="{{ $partner->phone }}">
                                </div>
                            </div>
                            ...
                            <div class="col-4 mt-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="address" required="" class="form-control" type="text"
                                        id="example-text-input" value="{{ $partner->address }}">
                                </div>
                            </div>
                            ...
                            <div class="col-4 mt-3">
                                ...
                                <div class="col-sm-10">
                                    <input required="" name="locationlink" class="form-control" type="text"
                                        id="example-text-input" value="{{ ltrim($partner->locationlink, '@') }}">
                                </div>
                            </div>
