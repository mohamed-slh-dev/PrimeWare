                         ...
                         @endif
                            ...
                            <div class="row text-center mt-3">
                                <div class="col-6 text-center ">
                                    <p class="text-center">
                                        <a href="tel:{{$order->driver_phone}}" class="profile-location-button showpage-action-buttons">
                                ...
                                <div class="col-6 text-center">
                                    <p class="text-center">
                                        <a href="{{route('customer.driver.chat', [$order->order_id]) }}" class="profile-location-button showpage-action-buttons">
