    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            <div class="page-content" style="margin-top: 0px; padding:0px">
                <form action="{{ route('collector.check.login') }}" method="post">
                     {{-- method fields --}}
                     @method('POST')
                     @csrf
                 <div class="container-fluid">
                    ...
                    <div class="row align-items-center" style="background: rgb(42, 42, 42)">
                        ...
                        <div class="col-12 profile-cols">
                            ...
                            <p>
                                <input class="custom-control profile-custom-inputs" type="text" name="email" id="name" required="" placeholder="E-mail (Collector)">
                            </p>
                        </div>
